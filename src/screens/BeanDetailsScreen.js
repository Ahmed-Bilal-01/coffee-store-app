    ...
    if (existingCartItem) {
      ...
      dispatch(
        addToCart({
          ...
          smallSizeLabel: '250gm',
          mediumSizeLabel: '500gm',
          largeSizeLabel: '750gm',
    ...
    <View style={styles.mainContainer}>
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.imageContainer}>
          ...
          >
            ...
            <TransparentView
              ...
              leftSmallButtonText={'Bean'}
              rightSmallButtonText={'Africa'}
              leftSmallButtonIcon={constants.svg.beansLogo}
              rightSmallButtonIcon={constants.svg.location}
              qualityText={itemQualityText}
              rating={'4.5'}
              totalRatings={'1,234'}
            />
        ...
        <View style={styles.body}>
          ...
          <SizeView
            buttonOnelabel={'250gm'}
            buttonTwolabel={'500gm'}
            buttonThreelabel={'750gm'}
            sizePrice={handlePrice}
          />
        </View>
      </ScrollView>
      <View>
        <Footer price={itemPrice} buttonLabel={'Add to Cart'} functionOnPress={storeData} />
      </View>
    </View>
  );
};
...
export default BeansDetailsScreen;
